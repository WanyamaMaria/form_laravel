...
class CreateRightsRequestUsersTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('rights_request_users', function (Blueprint $table) {
     $table->id();
    $table->foreignId('rights_request_id')->constrained()->onDelete('cascade');
   $table->string('staff_name');
    ...
    {
        Schema::dropIfExists('rights_request_users');
    }
};
